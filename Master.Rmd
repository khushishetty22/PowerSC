...
# Load the dataset
data <- read_csv("C:/Users/puroh/OneDrive/Documents/PowerSC/Final/Cleaned_Merged_Dataset.csv")
...
# Load the training dataset
train_data <- read_csv("C:/Users/puroh/OneDrive/Documents/PowerSC/Final/Cleaned_Merged_Dataset.csv")
...
# Load the new test dataset for July with the increased temperature
test_data <- read_csv("C:/Users/puroh/OneDrive/Documents/PowerSC/Final/test_july_increased.csv")
test_data$time <- as.POSIXct(test_data$time, format = "%Y-%m-%d %H:%M:%S")
test_data$`Dry.Bulb.Temperature...C.` <- test_data$`Dry.Bulb.Temperature...C.` + 5
